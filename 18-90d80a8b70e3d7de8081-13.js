...
"use strict";
function autoLink(e,t,i){var r,n,a,o,c,L,T,l,s,A,_,u;if(t.charAt(0)===C_LT){for(r=this,n="",a=t.length,o=0,c="",T=!1,l="",o++,n=C_LT;o<a&&(L=t.charAt(o),!(whitespace(L)||L===C_GT||L===C_AT_SIGN||":"===L&&t.charAt(o+1)===C_SLASH));)c+=L,o++;if(c){if(l+=c,c="",L=t.charAt(o),l+=L,o++,L===C_AT_SIGN)T=!0;else{if(":"!==L||t.charAt(o+1)!==C_SLASH)return;l+=C_SLASH,o++}for(;o<a&&(L=t.charAt(o),!whitespace(L)&&L!==C_GT);)c+=L,o++;if(L=t.charAt(o),c&&L===C_GT)return!!i||(l+=c,A=l,n+=l+L,s=e.now(),s.column++,s.offset++,T&&(l.slice(0,MAILTO_LENGTH).toLowerCase()===MAILTO?(A=A.substr(MAILTO_LENGTH),s.column+=MAILTO_LENGTH,s.offset+=MAILTO_LENGTH):l=MAILTO+l),_=r.inlineTokenizers.escape,r.inlineTokenizers.escape=null,u=r.enterLink(),A=r.tokenizeInline(A,s),r.inlineTokenizers.escape=_,u(),e(n)({type:"link",title:null,url:decode(l),children:A}))}}}var whitespace=__webpack_require__("5FGK"),decode=__webpack_require__("dTZW"),locate=__webpack_require__("uYcj");module.exports=autoLink,autoLink.locator=locate,autoLink.notInLink=!0;var C_LT="<",C_GT=">",C_AT_SIGN="@",C_SLASH="/",MAILTO="mailto:",MAILTO_LENGTH=MAILTO.length;
